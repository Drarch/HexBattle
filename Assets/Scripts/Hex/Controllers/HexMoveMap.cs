...
public partial class HexMoveMap
{
    ...
    public void SelectMap(HexTile root, int player)
    {
        ...
        {
            if (root.Map.Tiles[root.AxialX + c.coordinateX, root.AxialY + c.coordinateY] != null)
            {
                HexTile tile = root.Map.Tiles[root.AxialX + c.coordinateX, root.AxialY + c.coordinateY];
